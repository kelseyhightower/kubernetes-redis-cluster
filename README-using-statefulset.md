...
redis-trib.py replicate --master-addr `dig +short redis-app-3.redis-service.default.svc.cluster.local`:6379 --slave-addr `dig +short redis-app-6.redis-service.default.svc.cluster.local`:6379
```
